package com.gamegards.gaming27._baccarat;
...
import com.gamegards.gaming27._baccarat.menu.DialogBaccaratHistory;
import com.gamegards.gaming27._baccarat.menu.DialogBaccaratWinHistory;
import com.gamegards.gaming27._baccarat.menu.DialogRulesBaccarat;
...
public class Baccarat_Socket extends BaseActivity implements View.OnClickListener{
    ...
    Button btGameAmount;
    ImageView ivWine,ivLose, txtGameRunning, txtGameBets;
    ...
    private static final  String URL = Const.SOCKET_IP+"baccarat";
    Socket mSocket;
...
//New Game Started here ------------------------------------------------------------------------
                                ...
                                if (status.equals("0") && !isGameBegning){
                                    // Clear any stuck dialogues first
...
//                            isConfirm = true;
    ...
    public void makeWinnertoPlayer(String chaal_user_id) {
        rltwinnersymble1.setVisibility(View.GONE);
        if (chaal_user_id.equals(user_id_player1) && !chaal_user_id.isEmpty()) {
            PlaySaund(R.raw.tpb_battle_won);
...
//        }
    ...
    private void RestartGame(boolean isFromonCreate){
        ...
        findViewById(R.id.rltOngoinGame).setVisibility(View.GONE);
        isPleasewaitShowed = false;
        removeRedBlackCards();
...
//            putbet(betplace);
    ...
    public void openGameRules(View view) {
        DialogRulesBaccarat.getInstance(context).show();
    }
    ...
    private void addCardonParentView(ViewGroup parentview,String image_card){
        ...
        int imageid = Functions.getCardResource(image_card);
