...
import com.gamegards.gaming27._AnimalRoulate.menu.DialogRulesAnimalRoulette;
...
//            ,R.drawable.ic_animal_wolf
    ...
    private static final String URL = Const.SOCKET_IP+"animal_roulette";
    Socket mSocket;
...
//                            isConfirm = true;
                            isBetputes = true;
                            VisiblePleaseBetsAmount(false);
                            if(AnimalRouletteModel.getRule_type().equalsIgnoreCase(gameroulate_String[0])){
                                bettiger+=GameAmount;
                                AnimalRouletteModel.select_amount = bettiger;
                            }else if(AnimalRouletteModel.getRule_type().equalsIgnoreCase(gameroulate_String[1])){
                                betsnake+=GameAmount;
                                AnimalRouletteModel.select_amount = betsnake;
                            }else if(AnimalRouletteModel.getRule_type().equalsIgnoreCase(gameroulate_String[2])){
                                betshark+=GameAmount;
                                AnimalRouletteModel.select_amount = betshark;
                            }else if(AnimalRouletteModel.getRule_type().equalsIgnoreCase(gameroulate_String[3])){
                                betfox+=GameAmount;
                                AnimalRouletteModel.select_amount = betfox;
                            }else if(AnimalRouletteModel.getRule_type().equalsIgnoreCase(gameroulate_String[4])){
                                betcheetah+=GameAmount;
                                AnimalRouletteModel.select_amount = betcheetah;
                            }else if(AnimalRouletteModel.getRule_type().equalsIgnoreCase(gameroulate_String[5])){
                                betbear+=GameAmount;
                                AnimalRouletteModel.select_amount = betbear;
                            }else if(AnimalRouletteModel.getRule_type().equalsIgnoreCase(gameroulate_String[6])){
                                betwhale+=GameAmount;
                                AnimalRouletteModel.select_amount = betwhale;
                            }else if(AnimalRouletteModel.getRule_type().equalsIgnoreCase(gameroulate_String[7])){
                                betlion+=GameAmount;
                                AnimalRouletteModel.select_amount = betlion;
                            }
                            animalRouletteAdapter.notifyDataSetChanged();
                        } else {
                            RemoveChips();
...
//                txtGameBets.setVisibility(View.GONE);
    ...
    private void  stopBetAnim() {
        txtGameBets.setVisibility(View.VISIBLE);
//        Glide.with(context) .asGif()
//                .load(R.drawable.stop_betting).into(txtGameBets);
