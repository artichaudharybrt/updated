...
import com.gamegards.gaming27._jhandhiMunda.menu.DialogRulesJhandiMunda;
...
public class JhandhiMunda_Socket extends BaseActivity implements View.OnClickListener{
    ...
    private static final  String URL = Const.SOCKET_IP+"jhandi_munda";
    Socket mSocket;
...
//                                                boolean iswin = false;
//                                                if(betting_list.size() != 0) {
//                                                    if (HEART_WINCOUNT != 0 && betting_list.contains("1")){
//                                                        iswin = true;
//                                                    } if (SPADE_WINCOUNT != 0 && betting_list.contains("2")){
//                                                        iswin = true;
//                                                    } if (DIAMOND_WINCOUNT != 0 && betting_list.contains("3")){
//                                                        iswin = true;
//                                                    } if (CLUB_WINCOUNT != 0 && betting_list.contains("4")){
//                                                        iswin = true;
//                                                    } if (FACE_WINCOUNT != 0 && betting_list.contains("5")){
//                                                        iswin = true;
//                                                    } if (FLAG_WINCOUNT != 0 && betting_list.contains("6")){
//                                                        iswin = true;
//                                                    }
//
...
//        }
    ...
    private void openBuyChipsListActivity() {
        Log.d("AddCash", "Add button clicked in JhandhiMunda Socket game - using centralized add cash function");
