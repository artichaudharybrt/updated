...
public class ChipsBuyPaymentAdapter extends RecyclerView.Adapter<ChipsBuyPaymentAdapter.ViewHolder> {
    Activity context;

    ArrayList<ChipsBuyModel> historyModelArrayList;


    public ChipsBuyPaymentAdapter(Activity context, ArrayList<ChipsBuyModel> historyModelArrayList) {
...
//            txtproname.setText(title);
            ...
            txtAmount.setText(Variables.DOLLAR+model.getAmount());
