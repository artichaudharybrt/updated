...
import com.gamegards.gaming27.Activity.BuyChipsListCrypto;
import com.gamegards.gaming27.Adapter.GameHistoryAdapter;
...
import com.gamegards.gaming27.Utils.MyDragShadowBuilder;
...
import com.gamegards.gaming27._Rummy.menu.DialogRulesRummy;
import com.gamegards.gaming27._RummyGodMode.DialogRummyAllUserCard;
import com.gamegards.gaming27._RummyGodMode.DialogRummyGadhiCardsList;
...
public class RummyPointSocket extends BaseActivity implements Animation.AnimationListener {
    ...
    boolean isFirstHighlight = false;
    boolean IsImPlaying = false;
    ...
    LinearLayout rlt_addcardview, lnr_cardhistory, lnr_gamehistory;
    TextView txt_timer, tv_pointStatus;
    ...
    ImageView imgpl1glow,imgpl2glow,imgpl3glow,imgpl4glow,imgpl5glow,imgpl6glow,imgpl7glow, img_cardhistory, img_gamehistory;
    ...
    private static final  String URL = Const.SOCKET_IP+"rummy";
    Socket mSocket;
    ...
    int count = 8;
    TextView txtGameFinish,tv_private_code;
    Timer timerstatus;
    int timertime = 500;
...
//        API_CALL_middlecard();
        ...
        try {
            ...
            table_type = intent.getStringExtra("private_table");
            if (table_type != null){
                ...
                Log.e("RES_CHECK" , ""+table_type+actiontype);
        ...
        img_cardhistory.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Animation animation = AnimationUtils.loadAnimation(RummyPointSocket.this, R.anim.slide_from_top_screen);
                lnr_cardhistory.startAnimation(animation);
                lnr_cardhistory.setVisibility(View.VISIBLE);
                getMyCardHistory();

            }
        });

        findViewById(R.id.tv_cardhistory_close).setOnClickListener(v -> {
            lnr_cardhistory.setVisibility(View.GONE);
        });

        img_gamehistory.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Animation animation = AnimationUtils.loadAnimation(RummyPointSocket.this, R.anim.slide_from_right_screen);
                lnr_gamehistory.startAnimation(animation);
                lnr_gamehistory.setVisibility(View.VISIBLE);
                getMyGameHistory();

            }
        });

        findViewById(R.id.tv_gamehistory_close).setOnClickListener(v -> {
            lnr_gamehistory.setVisibility(View.GONE);
        });

    }

    private void getMyCardHistory() {
            ...
            public void Responce(String resp, String type, Bundle bundle) {
                ...
                try {
                    ...
                    if(code.equals("200")){
                        ...
                        JSONArray discarded_card = jsonObject.optJSONArray("discarded_card");
                        addMyCardHistoryonView(discarded_card);
    ...
    LinearLayout lnrMycardlist;
    private void addMyCardHistoryonView(JSONArray discarded_card) throws JSONException {
        lnrMycardlist = findViewById(R.id.lnrMycardlist);
        lnrMycardlist.removeAllViews();
        for (int i = 0; i < discarded_card.length() ; i++) {

            String card = discarded_card.getJSONObject(i).getString("card");

            addMyCardHistory(card,i);
        }

    }

    private void addMyCardHistory(String items, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.my_cardhistory_layout,null);
        ImageView ivcard = view.findViewById(R.id.ivcard);

        if(!items.equals("") && !items.equals("null") &&
                items.substring(items.length() - 1).equalsIgnoreCase("_"))
        {
            items = removeLastChars(items,1);
        }

        int imageResource1 = Functions.GetResourcePath(items.toLowerCase(),context);
        Log.e("RES_VALUE","Imagepath "+items.toLowerCase());

        // if(imageResource1 > 0 && isSplit)
        if(imageResource1 > 0)
        {
            LoadImage().load(imageResource1).into(ivcard);
        }


        lnrMycardlist.addView(view);
    }
    ...
    private void getMyGameHistory() {
        ...
        ApiRequest.Call_Api(this, Const.rummy_point_user_game_history, params, new Callback() {
            @Override
            public void Responce(String resp, String type, Bundle bundle) {
                ...
                try {
                    ...
                    if(code.equals("200")){
                       ...
                       Log.e("RES_GameHistory",resp);
                        ...
                        ((RecyclerView) findViewById(R.id.rec_gamehistory)).setVisibility(View.VISIBLE);
...
//                            return;
                            ...
                            RecyclerView rec_gamehistory = findViewById(R.id.rec_gamehistory);
                            rec_gamehistory.setLayoutManager(new LinearLayoutManager(context));
                            GameHistoryAdapter gameHistoryAdapter = new GameHistoryAdapter(context,game_users_cards_list);
                            rec_gamehistory.setAdapter(gameHistoryAdapter);
                        ...
                        ((TextView) findViewById(R.id.tv_nodata)).setText(message);
                        ((RecyclerView) findViewById(R.id.rec_gamehistory)).setVisibility(View.GONE);
                    }
            ...
            public void call(Object... args) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Log.e("RES_CHECK ", "ON-reconnect " + args);
            ...
            public void call(Object... args) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Log.e("RES_CHECK ", "ON-connect_error " + args);
        ...
        mSocket.on(Socket.EVENT_DISCONNECT, new Emitter.Listener() {
            ...
            public void call(Object... args) {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Log.e("RES_CHECK ", "ON-Disconnect3 " + args);
                        //rltGameReconnect.setVisibility(View.GONE);
                        //API_CALL_get_table();
...
//                        Log.e("RES_CHECK", "Transport error " + e);
//                        e.printStackTrace();
            ...
            public void call(Object... args) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        String resp = String.valueOf(args[0]);
                        Log.e("RES_CHECK","ON-get-table "+resp);
                        ...
                        try {
                            ...
                            if(code.equalsIgnoreCase("200"))
                            {
                                ...
                                tv_private_code.setText(""+table_id);
            ...
            public void call(Object... args) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        String resp = String.valueOf(args[0]);
                        Log.e("RES_CHECK","ON-get-private-table "+resp);
            ...
            public void call(Object... args) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        String response = String.valueOf(args[0]);
                        Log.e("RES_CHECK","ON-leave-table ");
                        mSocket.disconnect();
                        try {
                            JSONObject jsonObject = new JSONObject(response);
                            String code = jsonObject.getString("code");
            ...
            public void call(Object... args) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        String response = String.valueOf(args[0]);
                        Log.e("RES_CHECK","ON-declare-back ");
            ...
            public void call(Object... args) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        String response = String.valueOf(args[0]);
                        Log.e("RES_CHECK","ON-check-my-card ");
                        try {
                            JSONObject jsonObject = new JSONObject(response);
            ...
            public void call(Object... args) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        String response = String.valueOf(args[0]);
                        Log.e("RES_CHECK","ON-join-table ");
                        Log.e("RES_VALUE","ON-join-table "+response);
            ...
            public void call(Object... args) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        String response = String.valueOf(args[0]);
                        Log.e("RES_CHECK","ON-get-drop-card ");
...
//                    Functions.showToast(context, ""+message);
    ...
    private void getGame(final String url) {
        Log.e("RES_CHECK","EMIT- "+url + "table_id" +table_id);
...
//
       ...
       // SetBackgroundImageAsDisplaySize(this,rltParentLayout,R.drawable.home_bg2);
        ...
        tv_pointStatus = findViewById(R.id.tv_pointStatus);
...
//            findViewById(R.id.rltplayer7).setVisibility(View.VISIBLE);
        ...
        lnr_cardhistory=findViewById(R.id.lnr_cardhistory);
        lnr_gamehistory=findViewById(R.id.lnr_gamehistory);
        ...
        img_cardhistory=findViewById(R.id.img_cardhistory);
        img_gamehistory=findViewById(R.id.img_gamehistory);
        ...
        tv_private_code=findViewById(R.id.tv_private_code);
    ...
    private void InitializationNonUi(){
    ...
    private void UserProgressCount() {
        ...
        mCountDownTimer1 = new CountDownTimer(timmersectlarge, timmersectsmall) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                if(pStatusprogress == 0){
                    SharedPreferences prefs = getSharedPreferences(MY_PREFS_NAME, MODE_PRIVATE);
                    String value = prefs.getString("isvibrateon", "1");
                ...
                if (pStatusprogress >= half_time) {
                    ...
                    mProgress1.setProgress(halfcountvalue*2);
...
//                ExitFromGames();      //need later
            ...
            public void Responce(String resp, String type, Bundle bundle) {
                ...
                if(resp.equals("onTick"))
                {
                    ...
                    if (pStatusprogress >= half_time) {
                        ...
                        halfcountvalue ++;
                        //Log.e("RES_VALUE" , "RED "+halfcountvalue);
                        mProgress2.setProgressTintList(ColorStateList.valueOf(Color.RED));
                        mProgress2.setProgress(halfcountvalue*2);
                        PlaySoundFx(R.raw.teenpattitick,true);
                        ...
                        mProgress2.setProgressTintList(ColorStateList.valueOf(Color.GREEN));
                        mProgress2.setProgress(halfcountvalue*2);
                        //Log.e("RES_VALUE" , "GREEN "+pStatusprogress);
                    }
            ...
            public void Responce(String resp, String type, Bundle bundle) {
                ...
                if(resp.equals("onTick"))
                {
                    ...
                    if (pStatusprogress >= half_time) {
                        ...
                        mProgress3.setProgress(halfcountvalue*2);
                        PlaySoundFx(R.raw.teenpattitick,true);
            ...
            public void Responce(String resp, String type, Bundle bundle) {
                ...
                if(resp.equals("onTick"))
                {
                    ...
                    if (pStatusprogress >= half_time) {
                        ...
                        mProgress4.setProgress(halfcountvalue*2);
                        PlaySoundFx(R.raw.teenpattitick,true);
            ...
            public void Responce(String resp, String type, Bundle bundle) {
                ...
                if(resp.equals("onTick"))
                {
                    ...
                    if (pStatusprogress >= half_time) {
                        ...
                        mProgress5.setProgress(halfcountvalue*2);
                        PlaySoundFx(R.raw.teenpattitick,true);
            ...
            public void Responce(String resp, String type, Bundle bundle) {
                ...
                if(resp.equals("onTick"))
                {
                    ...
                    if (pStatusprogress >= half_time) {
                        ...
                        mProgress6.setProgress(halfcountvalue*2);
                        PlaySoundFx(R.raw.teenpattitick,true);
            ...
            public void Responce(String resp, String type, Bundle bundle) {
                ...
                if(resp.equals("onTick"))
                {
                    ...
                    if (pStatusprogress >= half_time) {
                        ...
                        mProgress7.setProgress(halfcountvalue*2);
                            PlaySoundFx(R.raw.teenpattitick,true);
    ...
    private void Player1CancelCountDown(String value){
//            mCountDownTimer1.onFinish();
        if (value.equalsIgnoreCase("highlight")) {
            mCountDownTimer1.cancel();
            if (!isFirstHighlight){

                if (!isRunning && IsImPlaying){
    ...
    private void API_CALL_get_table() {
        ...
        try {
            ...
            if(isPlayer2)
                ...
                jsonObject.put("no_of_players","6");
            ...
            if(getIntent().hasExtra(SEL_TABLE))
            {
                ...
                jsonObject.put("boot_value", "Hello");
               // return;
            }
        } catch (JSONException e) {
            e.printStackTrace();
        ...
        Log.e("RES_CHECK","EMIT-get-table ");
        Log.e("RES_VALUE","EMIT-get-table "+jsonObject);


    }

    private void API_CALL_get_private_table() {
        ...
        mSocket.emit("get-private-table",jsonObject);
        Log.e("RES_CHECK","EMIT-private_get-table ");
        Log.e("RES_VALUE","MIT-private_get-table "+jsonObject);
...
//                    LoadImage().load(Const.IMGAE_PATH + profile_pic).into(imgpl1circle);
            ...
            for (int k = 0; k < table_users.length(); k++) {
                Log.e("RES_TABLE_LEN", String.valueOf(table_users.length()));
                if (k == 0) {
    ...
    private void API_CALL_pack_game() {
        ...
        Log.e("RES_CHECK","EMIT-pack-game");
        Log.e("RES_VALUE","EMIT-pack-game "+Submitcardslist);
    ...
    private void API_CALL_leave_table(final String value) {
        ...
        Log.e("RES_CHECK","EMIT-leave-table");
...
//                    }
    ...
    private void API_CALL_start_game() {
        ...
        Log.e("RES_CHECK","EMIT-start-game");
    }
...
//            return;
        ...
        Log.e("RES_Count" ," rlt_addcardview.getChildCount() = "+rlt_addcardview.getChildCount());
        ...
        ApiRequest.Call_Api(this, Const.status, params, new Callback() {
            ...
            public void Responce(String resp, String type, Bundle bundle) {
                ...
                try {
                    JSONObject jsonObject = new JSONObject(resp);
                    Log.v("RES_GAME STATUS", " " + String.valueOf(resp));
                    Parse_responseStatus(jsonObject);
                    //                    Log.e("status" , "working -   "+jsonObject);
    ...
    private void checkMyCards() {
        ...
        if(my_count != 13 )
        {
            ...
            Log.e("RES_CHECK","EMIT-check-my-card");
    ...
    private void Parse_responseStatus(JSONObject jsonObject) throws JSONException {
        Log.e("RES_VALUE","3"+jsonObject.toString());
        String code = jsonObject.optString("code");
        String message = jsonObject.optString("message");
      ...
      //  Log.e("RES_CHECK","1 "+jsonObject);
            ...
            for (int i = 0; i < game_users.length() ; i++) {
                ...
                if(user_id.equals(prefs.getString("user_id", ""))) {
                    if(packed.equals("1")) {
                        ...
                        isGamePacked = true;
                        ((TextView)findViewById(R.id.tv_gamemessage)).setVisibility(View.VISIBLE);
        ...
        if(code.equalsIgnoreCase("200")) {
            ...
            Log.e("RES_VALUE","declare_user_id = "+ declare_user_id+ "user_id ="+prefs.getString("user_id", "")+ "declare = "+ declare +"game_declare"+game_declare);
            ...
            if(game_status.equalsIgnoreCase("2") || game_status.equalsIgnoreCase("0"))
            {
                ...
                isgamestarted = false;
                complategameUIChange();
                Log.e("RES_CHECK" , "game_status -  Finish or About to start "+game_status);
            ...
            {
                Log.e("RES_CHECK" , "game_status -  New Game Start "+game_status);
                //   bt_startgame.setVisibility(View.GONE);
                rltwinnersymble1.setVisibility(View.GONE);
                rltwinnersymble2.setVisibility(View.GONE);
                rltwinnersymble3.setVisibility(View.GONE);
                ...
                if (!isRunning) {
                    ...
                    Log.e("RES_CHECK" ,"!isRunning");
                    if (!isgamestarted && !isGamePacked) {
                        Log.e("RES_CHECK" ,"!isgamestarted && !isGamePacked");
                        API_CALL_getCardList();

                    } else if (isgamestarted && rlt_addcardview.getChildCount() <= 0 ) {
                        Log.e("RES_CHECK" ,"isgamestarted && rlt_addcardview.getChildCount()");
                        API_CALL_getCardList();
            ...
            if(drop_card != null)
            {
                Log.e("RES_VALUE" ,  ""+drop_card );
// Card that will show in middle.
                if(drop_card.length() > 0)
                {
                    for (int i = 0; i < drop_card.length() ; i++) {
                        ...
                        Log.e("RES_VALUE","Imagepath "+model.Image.toLowerCase());
...
//                            return;
                ...
                DialogDeclareCardsPoint daDialogDeclareCardsPoint = new DialogDeclareCardsPoint(context){
                    @Override
                    public void startGame(String resp) {
                        makeWinnertoPlayer("");
                        tv_pointStatus.setVisibility(View.GONE);
                        if(resp.equalsIgnoreCase("startgame"))
                        {
                          //  API_CALL_start_game();
                            new CountDownTimer(7000, 1000) {
                                @Override
                                public void onTick(long millisUntilFinished) {
                                    ((TextView)findViewById(R.id.tv_gamemessage)).setVisibility(View.GONE);
                                    txtGameFinish.setVisibility(View.VISIBLE);
                                    txtGameFinish.setText("Round will start in " + (millisUntilFinished/1000)+" second");
                                }
...
//                        isDeclareDialogShow = false;
    ...
    private void InitializeUsers
            (String user_id_player,JSONObject table_users,TextView txtPlay,TextView txtPlaywallet,ImageView imgplcircle,View lnrPlaywallet,ImageView imgwaiting)
            throws JSONException {

        String table_id1 = table_users.getString("table_id");
        final String name1 = table_users.getString("name");
   //     user_id_player = table_users.getString("user_id");
        String profile_pic1 = table_users.getString("profile_pic");
        String walletplayer2 = table_users.getString("wallet");

        Log.e("RES_Users",user_id_player);
        ...
        if (user_id_player.equals("0")) {
            ...
            imgwaiting.setVisibility(View.INVISIBLE);
    ...
    private void Parse_response(JSONObject jsonObject) throws JSONException {
        ...
        Log.e("RES_VALUE" , "my-card "+jsonObject);
        ...
        if(code.equalsIgnoreCase("200"))
        {
...

            {
                ...
                cardDistrubutionCount = new CountDownTimer(cardModelArrayList.size() * Variables.cardDistributionInterverl,
                    ...
                    @Override
                    public void onTick(long millisUntilFinished) {
                        Log.e("RES_CHECK" , "startGameCardDrawnAnimation");
    ...
    private void addCardsinMainList(){
        ...
        new CountDownTimer(cardModelArrayList.size() * nextCardFlipDelay , nextCardFlipDelay){
            ...
            public void onTick(long millisUntilFinished) {
                ...
                try {
                    Log.e("RES_CHECK" , "AllCardFlipAnimation");
    ...
    private void CreateGroupFromSelect(boolean isDrag){
        ...
        if(count < 2 && !isDrag)
        {
            Functions.showToast(this, ""+getString(R.string.minimum_grouping2));
            return;
        }
    ...
    private void API_CALL_drop_card(final ArrayList<CardModel> arrayList, final int countnumber) {
        ...
        Log.e("RES_CHECK","EMIT-drop-card");

    }

    private void API_CALL_wrong_declare() {
        ...
        mSocket.emit("wrong-delclare",jsonObjectDropCard);
        Log.e("RES_CHECK","EMIT-wrong-delclare");
    ...
    private void API_CALL_get_drop_card() {
        ...
        Log.e("RES_CHECK","EMIT-get-drop-card");
    ...
    public void highlight(String player){
        ...
        {
            isProgressrun1 = true;
            Log.e("RES_Function", "highlight");

            Player1CancelCountDown("highlight");
            mProgress1.setProgress(0);
            txt_timer.setVisibility(View.GONE);
            imgpl1glow.setVisibility(View.GONE);
        }
    ...
    public void StopSound(){
        Log.e("RES_Function" , "StopSound");
        cancelSound();

        if(mCountDownTimer1 != null)
        {
            Player1CancelCountDown("StopSound");
        }
...
//            if(!opponent_game_declare)
        ...
        if(rs_cardlist_group1.size() > 0)
        {
            ...
            Log.e("RES_VALUE" ,"rs_cardlist_group1 - "+grouplist.toString());
        ...
        if(rp_cardlist_group2.size() > 0)
        {
            ...
            Log.e("RES_VALUE" ,"rp_cardlist_group2 - "+grouplist.toString());
        ...
        if(bl_cardlist_group3.size() > 0)
        {
            ...
            Log.e("RES_VALUE" ,"rp_cardlist_group3 - "+grouplist.toString());
        ...
        if(bp_cardlist_group4.size() > 0)
        {
            ...
            Log.e("RES_VALUE" ,"rp_cardlist_group4 - "+grouplist.toString());
        ...
        if(joker_cardlist_group5.size() > 0)
        {
            ...
            Log.e("RES_VALUE" ,"rp_cardlist_group5 - "+grouplist.toString());
        ...
        if(ext_group1.size() > 0)
        {
            ...
            Log.e("RES_VALUE" ,"ext_group1 - "+grouplist.toString());
        ...
        if(ext_group2.size() > 0)
        {
            ...
            Log.e("RES_VALUE" ,"ext_group2 - "+grouplist.toString());
        ...
        if(ext_group3.size() > 0)
        {
            ...
            Log.e("RES_VALUE" ,"ext_group3 - "+grouplist.toString());
        ...
        if(ext_group4.size() > 0)
        {
            ...
            Log.e("RES_VALUE" ,"ext_group4 - "+grouplist.toString());
        ...
        if(ext_group5.size() > 0)
        {
            ...
            Log.e("RES_VALUE" ,"ext_group5 - "+grouplist.toString());
        ...
        Log.e("RES_VALUE" ,"grouplist - "+grouplist.toString()+"grouplist_size "+grouplist_size);

        groupvalueList.clear();
        fistlife_position = -1;

        String total_groupPoints = "0";
        int inttotal_groupPoints = 0;

        for (int i = 0; i < grouplist.size() ; i++) {
            card_count = 0;
            CreateGroups(grouplist.get(i),i);
            total_groupPoints= grouplist.get(i).get(0).group_points;
            Log.e("RES_VALUE","Group_Points "+total_groupPoints);
            if (total_groupPoints.equals("Impure sequence")){
                total_groupPoints="0";
            } if(total_groupPoints.equals("Pure Sequence")){
                total_groupPoints="0";
            }if(total_groupPoints.equals("set")){
                total_groupPoints="0";
            }
            inttotal_groupPoints += Integer.parseInt(total_groupPoints);

        }

        if(str_1st_life.equals("1") && str_2nd_life.equals("1")){
            tv_pointStatus.setVisibility(View.VISIBLE);
            tv_pointStatus.setText(""+inttotal_groupPoints +" points");
        }else {
            tv_pointStatus.setVisibility(View.VISIBLE);
            tv_pointStatus.setText("80 points");
        }
                ...
                if(isFinishDesk)
                {
                    ...
                    new Handler().postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            Log.e("RES_CHECK" ,"isFinishDesk Declare ");
                            API_CALL_declare();
                        }
                    },500);
                    ...
                    if(isResentCardDrop)
                    {
                        new Handler().postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                Log.e("RES_CHECK" ,"isFinishDesk isResentCardDrop ");
                                API_CALL_declare();
                            }
                        },500);
                    }
...
//        rlt_addcardview.addView(view,layoutParams);
        ...
        // If rlt_addcardview is a child view, use the parent's layout parameters
        ViewGroup.LayoutParams params = rlt_addcardview.getLayoutParams();
        // Set the width of rlt_addcardview to MATCH_PARENT
        params.width = ViewGroup.LayoutParams.MATCH_PARENT;
        // Apply layout parameters to the parent view
        rlt_addcardview.setLayoutParams(params);
        // Add the view to the parent view with the specified layout parameters
        rlt_addcardview.addView(view, layoutParams);
            ...
            public boolean onDrag(View view, DragEvent event) {
                switch (event.getAction()) {
                    ...
                    case DragEvent.ACTION_DRAG_ENDED:
                        CreateGroupViewVisible(false);
                        isViewonTouch = false;
                        API_CALL_status();// APi call on drag card action
                        return true;
                }
                return false;
            }
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                switch (action) {
                    case MotionEvent.ACTION_DOWN: {
                        ...
                        Log.e("RES_CHECK_TOUCH","down");
                        break;
                    }
                    case MotionEvent.ACTION_MOVE: {
                        Log.e("RES_CHECK_TOUCH","move");
                    ...
                    case MotionEvent.ACTION_UP: {
                        ...
                        Log.e("RES_VALUE_TOUCH",isTouchLength+"  "+isClickTime);
                        Log.e("RES_CHECK_TOUCH","up");
...
//        });
    ...
    public void vibrateMyTurn() {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            ...
            // this effect creates the vibration of default amplitude for 500ms(1/2 sec)
    ...
    public void makewaitingon(String user_id) {
        ...
        } else if (user_id.equals(user_id_player6)) {
            imgwaiting6.setVisibility(View.GONE);
        } else {
