...
public class DialogDeclareCardsPoint {
    Context context;
    ...
    public DialogDeclareCardsPoint(Context context) {
        this.context = context;
        initDialog();
    }

    public DialogDeclareCardsPoint setGame_users_cards_list(ArrayList<CardModel> game_users_cards_list, String str_game_id) {
        ...
        DeclareAdapter declareAdapter = new DeclareAdapter(context,game_users_cards_list,"rummy_point");
...
//            }
    ...
    public DialogDeclareCardsPoint setGame_start_time(int game_start_time) {
    ...
    Dialog dialog;
    private DialogDeclareCardsPoint initDialog() {
        dialog = Functions.DialogInstance(context);
        dialog.setContentView(R.layout.dialog_declare_result_point);
