        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    // Always navigate to WalletConnect screen after splash
                    startActivity(new Intent(Splashscreen.this, com.gamegards.gaming27.wallet.WalletConnectActivity.class));
