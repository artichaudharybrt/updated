package com.gamegards.gaming27._CarRoullete;
...
import com.gamegards.gaming27._CarRoullete.menu.DialogRulesCarRoulette;
...
public class CarRoullete_Socket extends BaseActivity implements View.OnClickListener {
    ...
    Button btGameAmount;
    ImageView imgpl1circle, ivWine, ivLose, txtGameRunning, txtGameBets;
    View ChipstoUser;
    ...
    private static final String URL = Const.SOCKET_IP+"car_roulette";
...
//                            isConfirm = true;
                            isBetputes = true;
                            VisiblePleaseBetsAmount(false);
                            if(carRollouteModel.getRule_type().equalsIgnoreCase(gameroulate_String[0])){
                                bettata+=GameAmount;
                                carRollouteModel.select_amount = bettata;
                            }else if(carRollouteModel.getRule_type().equalsIgnoreCase(gameroulate_String[1])){
                                betmahindra+=GameAmount;
                                carRollouteModel.select_amount = betmahindra;
                            }else if(carRollouteModel.getRule_type().equalsIgnoreCase(gameroulate_String[2])){
                                betaudi+=GameAmount;
                                carRollouteModel.select_amount = betaudi;
                            }else if(carRollouteModel.getRule_type().equalsIgnoreCase(gameroulate_String[3])){
                                betbmw+=GameAmount;
                                carRollouteModel.select_amount = betbmw;
                            }else if(carRollouteModel.getRule_type().equalsIgnoreCase(gameroulate_String[4])){
                                betmercides+=GameAmount;
                                carRollouteModel.select_amount = betmercides;
                            }else if(carRollouteModel.getRule_type().equalsIgnoreCase(gameroulate_String[5])){
                                betporche+=GameAmount;
                                carRollouteModel.select_amount = betporche;
                            }else if(carRollouteModel.getRule_type().equalsIgnoreCase(gameroulate_String[6])){
                                betlombergini+=GameAmount;
                                carRollouteModel.select_amount = betlombergini;
                            }else if(carRollouteModel.getRule_type().equalsIgnoreCase(gameroulate_String[7])){
                                betferrari+=GameAmount;
                                carRollouteModel.select_amount = betferrari;
                            }
