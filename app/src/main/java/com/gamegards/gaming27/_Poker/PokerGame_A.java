...
public class PokerGame_A extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        blind_1 = getIntent().getStringExtra("blind_1");
        ...
        dialogRaisePrice.setCallback(new OnItemSelect() {
            ...
            public void onItemSelect(View view, int position, Object object) {
               /* switch (view.getId())
                ...
                if (view.getId() == R.id.btnAllin) {
                    // No action needed for btnAllin, equivalent to the 'break' in switch
                } else if (view.getId() == R.id.btnFullPot) {
                    mRaiseValue = FULLPOT;
                } else if (view.getId() == R.id.btnHalfpot) {
                    mRaiseValue = HALFPOT;
                }
...
//                params.put("poker_table_id", table_id);
                ...
                params.put("blind_1", blind_1);

//                if(getIntent().hasExtra(SEL_TABLE))
//                {
//                    String blind_1 = getIntent().getStringExtra(SEL_TABLE);
//                    Log.v("Res_response","Check_blind_1"+blind_1);
//                    params.put("blind_1", blind_1);
//                    Log.v("Res_response","Check_blind_1"+blind_1);
//
//                }
...
//first player
                ...
                if (user_id_player2.equals("0")) {
                    ...
                    imgpl2circle.setVisibility(View.VISIBLE);
                    Log.v("RES_RESPONSE","RES_CHECK"+Const.IMGAE_PATH + profile_pic1);
...
//second player
                ...
                if (user_id_player3.equals("0")) {
                    ...
                    imgpl3circle.setVisibility(View.VISIBLE);
...
//third player
                ...
                if (user_id_player4.equals("0")) {
                    ...
                    imgpl4circle.setVisibility(View.VISIBLE);
                ...
                if (walletplayer5.equals("0")) {
                    ...
                    imgpl5circle.setVisibility(View.VISIBLE);
