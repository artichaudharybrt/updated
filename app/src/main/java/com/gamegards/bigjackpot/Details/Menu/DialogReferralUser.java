...
import com.gamegards.bigjackpot.Details.Adapter.ReferalUserAdapter;
...
public class DialogReferralUser {
    ...
    final ArrayList<com.gamegards.bigjackpot.Details.Menu.ReferralModel> referralModels;
                ...
                try {
                    ...
                    if (code.equalsIgnoreCase("200")) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            com.gamegards.bigjackpot.Details.Menu.ReferralModel model = new com.gamegards.bigjackpot.Details.Menu.ReferralModel();
