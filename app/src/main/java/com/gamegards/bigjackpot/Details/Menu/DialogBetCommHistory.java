...
import com.gamegards.bigjackpot.MyAccountDetails.MyBetAdapte;
...
public class DialogBetCommHistory {
    ...
    MyBetAdapte myBetAdapte;

    public DialogBetCommHistory(Context context) {
        this.context = context;
        alert = Functions.DialogInstance(context);
        alert.setContentView(R.layout.dialog_betcomm);
        alert.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        TextView tvTitle = alert.findViewById(R.id.txtheader);
        tvTitle.setText("Bet Commission");
    ...
    private void CALL_API_GET_LIST(){
        ...
        ApiRequest.Call_Api(context, Const.USER_BETCOMM, params, new Callback() {
            @Override
            public void Responce(String resp, String type, Bundle bundle) {
                ...
                try {
                    ...
                    if (code.equalsIgnoreCase("200")) {
                        ...
                        JSONArray jsonArray = jsonObject.getJSONArray("bet_commission_log");
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            model.setPurchase_user_id(jsonObject1.optString("bet_user_id"));
                            model.setAmount(jsonObject1.optString("bet_amount"));
                ...
                myBetAdapte = new MyBetAdapte(context,redeemModelArrayList);
                rec_winning.setAdapter(myBetAdapte);
