...
public class QrRedeemHistoryAdapter extends RecyclerView.Adapter<QrRedeemHistoryAdapter.myholder> {

    Context homepage;
    ArrayList<RedeemModel> winnigmodelArrayList;

    public QrRedeemHistoryAdapter(Context homepage, ArrayList<RedeemModel> winnigmodelArrayList) {
    ...
    public myholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(homepage).inflate(R.layout.qr_itemview, parent, false);
    ...
    public void onBindViewHolder(@NonNull myholder holder, int position) {
        ...
        getTextView(view,R.id.tvStatus).setText("" + model.getStatus());
