...
public class MyWinningAdapte extends RecyclerView.Adapter<MyWinningAdapte.Myholder> {
    ...
    public void onBindViewHolder(@NonNull Myholder holder, int position) {
        ...
        String utcTime = myWinnigmodelArrayList.get(position).added_date;
        String istTime = TimeConversion.convertToIST(utcTime);

        getTextView(view,R.id.tvDates).setText(""+istTime);
