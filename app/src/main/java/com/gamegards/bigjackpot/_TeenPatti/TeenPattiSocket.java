...
public class TeenPattiSocket extends BaseActivity {
    ...
    txtPlay1wallet, txtBallence, txtPlay2wallet, txtCounttimer, txtCounttimer1, txtCounttimer2, txtCounttimer3,
            txtCounttimer4, txtCounttimer5, txtPlay3wallet, txtPlay4wallet, txtPlay5wallet, txtTableid,txtTableId,
    ...
    private ImageView imgpl1Frame, imgpl2Frame, imgpl3Frame, imgpl4Frame, imgpl5Frame;
    ...
    private static final String URL = SOCKET_IP+"teenpatti";
    Socket mSocket;
    ImageView imgGameReconnect;
    RelativeLayout rltGameReconnect;
    boolean isPinged = true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Intent.ACTION_VIEW.equals(intent.getAction())) {
            ...
            if (getIntent().hasExtra(SEL_TABLE)) {
                ...
                getGame("get-table");
                Log.e("RES_CHECK", "Normal Table Select");
            } else {
                ...
                if (gameType.equals(CUSTOME_TABLE)) {
                    ...
                    Log.e("RES_CHECK", "Custom Table Select");

                } else if (gameType.equals(PRIVATE_TABLE)) {
                    //   getGame(Const.PRI_GAME_TABLE_CREAT,bootvalue);
                    String table_type = getIntent().getStringExtra("table_type");

                    if (table_type.equals("join")){
                    ...
                    Log.e("RES_CHECK", "Private Table Select"+bootvalue);
                }
            }
        ...
        mSocket.on("connect_error", new Emitter.Listener() {
            ...
            public void call(Object... args) {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                      //  imgNetwork.setImageDrawable(context.getDrawable(R.drawable.wpoor));
            ...
            public void call(Object... args) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Log.e("RES_CHECK", "ON GET-table "+response);
            ...
            public void call(Object... args) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        String response = String.valueOf(args[0]);
                        Log.e("RES_CHECK", "ON join-table "+response);
                        handleResponse(response);
            ...
            public void call(Object... args) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        String response = String.valueOf(args[0]);
                        Log.e("RES_CHECK" , "On-get-customise-table");
            ...
            public void call(Object... args) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        String response = String.valueOf(args[0]);
                        Log.e("RES_CHECK" , "On-get-private-table");
...
//                                                Toast.LENGTH_LONG).show();
        ...
        mSocket.on("switch-table", new Emitter.Listener() {
            ...
            public void call(Object... args) {
                ...
                String resp = String.valueOf(args[0]);
                Log.e("RES_CHECK" , "On-switch-table");
            ...
            public void call(Object... args) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        String resp = String.valueOf(args[0]);
                        Log.e("RES_CHECK", "ON-leave-table"+resp);


//                        if (valueforGameQuite.equals("0")) {
//
//                           // finish();
//                            mSocket.disconnect();
//
...
//                        }
        ...
        txtTableId.setText("Table id - "+table_id);
    }
...
//                        Toast.LENGTH_LONG).show();
        ...
        btnStartGame.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //  GameStart();
                mSocket.emit("start-game", jsonObjectUser);
                Log.e("RES_CHECK" ,  "EMIT_start-game");
            }
        });
            ...
            public void onClick(View view) {
                ...
                if (playercount > 2) {
                    ...
                    Executors.newSingleThreadExecutor().execute(() -> {
                        ...
                        Log.e("RES_CHECK" ,  "EMIT_show-game");
...
//
//                isChalClick = true;
                float tableamountvalue = Float.parseFloat(table_amount);
                float firstplayer = Float.parseFloat(walletplayer1);
                if (firstplayer >= updatedamount && firstplayer >= tableamountvalue){

                    GameChhal();

                }else {
                    Log.d("PrivateTable", "Insufficient balance in TeenPatti private table - showing add cash dialog");
                    Functions.SmartAlertDialogWithAddCash(context,
                        "Insufficient Balance",
                        "You need ₹" + Math.max(updatedamount, tableamountvalue) + " to continue. Your current balance is ₹" + firstplayer + ".",
                        new Callback() {
                            @Override
                            public void Responce(String resp, String type, Bundle bundle) {
...
//                isChalClick = true;
                ...
                if (firstplayer >= updatedamount && firstplayer >= tableamountvalue){
                    ...
                    Log.d("PrivateTable", "Insufficient balance in TeenPatti private table blind - showing add cash dialog");
                    Functions.SmartAlertDialogWithAddCash(context,
                        "Insufficient Balance",
                        "You need ₹" + Math.max(updatedamount, tableamountvalue) + " to continue. Your current balance is ₹" + firstplayer + ".",
                        new Callback() {
...
//                imgplayer5mainfirst.startAnimation(animMoveCardsPlayer5);
    ...
    public void showSlideshowCardsafterPack(JSONArray slide_show_from_cards, JSONArray slide_show_to_cards) {
       Log.e("RES_CHECK" , "showSlideshowCardsafterPack");
...
//        }
    ...
    private void getGame(final String event_name) {
        ...
        Log.e("RES_CHECK","EMIT"+event_name);
    ...
    private void GameStatus() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Const.GAME_STATUS,
                new Response.Listener<String>() {
                    ...
                    @Override
                    public void onResponse(String response) {
                        Log.e("RES_VALUE" , "response - "+response);
                        ...
                        try {
                            ...
                            for (int k = 0; k < jsonArrayuser.length(); k++) {
                                if (k == 0) {
                                    ...
                                    user_id_player1 = jsonArrayuser.getJSONObject(0).getString("user_id");

                                    String profile_pic = jsonArrayuser.getJSONObject(0).getString("profile_pic");
                                    LoadImage().load(Const.IMGAE_PATH + profile_pic).into(imgpl1Frame);
                                    ...
                                    if (user_id_player1.equals(prefs.getString("user_id", ""))) {
                                        ...
                                        Functions.showToast(context, "Your are timeout from this table Join again.");
                                        finish();
                                    }
                                    imgchipuser1.setVisibility(View.VISIBLE);
//first player
                                    ...
                                    String table_id1 = jsonArrayuser.getJSONObject(1).getString(
                                            "table_id");
                                    // Use actual user name from server response instead of random names
                                    final String name1 = jsonArrayuser.getJSONObject(1).getString("name");
                                    user_id_player2 = jsonArrayuser.getJSONObject(1).getString(
                                            "user_id");
                                    String profile_pic1 =
                                            jsonArrayuser.getJSONObject(1).getString("profile_pic");
                                    LoadImage().load(Const.IMGAE_PATH + profile_pic1).into(imgpl2Frame);
...
//second player
                                    ...
                                    String table_id3 = jsonArrayuser.getJSONObject(2).getString("table_id");
                                    final String name3 = jsonArrayuser.getJSONObject(2).getString("name");
                                    user_id_player3 = jsonArrayuser.getJSONObject(2).getString("user_id");
                                    String profile_pic3 = jsonArrayuser.getJSONObject(2).getString("profile_pic");
                                    LoadImage().load(Const.IMGAE_PATH + profile_pic3).into(imgpl3Frame);
                                    walletplayer3 = jsonArrayuser.getJSONObject(2).getString("wallet");
...
//third player
                                    ...
                                    String table_id4 = jsonArrayuser.getJSONObject(3).getString("table_id");
                                    final String name4 = jsonArrayuser.getJSONObject(3).getString("name");
                                    user_id_player4 = jsonArrayuser.getJSONObject(3).getString("user_id");
                                    String profile_pic4 = jsonArrayuser.getJSONObject(3).getString("profile_pic");
                                    LoadImage().load(Const.IMGAE_PATH + profile_pic4).into(imgpl4Frame);
                                    walletplayer4 = jsonArrayuser.getJSONObject(3).getString("wallet");
                                    ...
                                    String table_id5 = jsonArrayuser.getJSONObject(4).getString("table_id");
                                    final String name5 = jsonArrayuser.getJSONObject(4).getString("name");
                                    user_id_player5 = jsonArrayuser.getJSONObject(4).getString("user_id");
                                    String profile_pic5 = jsonArrayuser.getJSONObject(4).getString("profile_pic");
                                    LoadImage().load(Const.IMGAE_PATH + profile_pic5).into(imgpl5Frame);
                                    walletplayer5 = jsonArrayuser.getJSONObject(4).getString("wallet");
                            ...
                            Log.e("RES_VALUE" , "slide_show_from_cards"+ slide_show_from_cards);
                            Log.e("RES_VALUE" , "slide_show_to_cards"+slide_show_to_cards);
...
//        Volley.newRequestQueue(this).add(stringRequest);
    ...
    private void GameChhal() {
        ...
        try {
            ...
            Log.e("RES_VALUE" , "sent Amount  = "+sentamounttype+" updatedamount "+  updatedamount +"table_amount "+table_amount);
...
//                    getTextView(R.id.tvSlideCountDown).setText((millisUntilFinished/1000)+" s");
    ...
    private void GameSideShow(final String prev_user_id) {
        ...
        Log.e("RES_CHECK" , "EMIT-slide-show");
        Log.e("RES_VALUE" , "EMIT-slide-show - " +jsonObjectSlideshow);
...
//        Volley.newRequestQueue(this).add(stringRequest);
    ...
    private void GameSideAction(final String slidshowid, final String slide_type) {
        ...
        Log.e("RES_CHECK" , "EMIT-do-slide-show");
        Log.e("RES_VALUE" , "EMIT-do-slide-show - " +jsonObjectDoslideshow);
...
//                                                Toast.LENGTH_LONG).show();
    ...
    private void GameTableChange() {
        ...
        Log.e("RES_CHECK" , "EMIT-switch-table");
...
//                                            Toast.LENGTH_LONG).show();
    ...
    public void openBuyChipsDetails(View view) {
        Log.d("PrivateTable", "openBuyChipsDetails clicked in TeenPatti Private Table - using centralized add cash function");
        // Use centralized add cash functionality instead of navigating to BuyChipsListCrypto
        Functions.showAddCash(this);
    }
...
//                                          @Override
//                                          public void run() {
//                                              Log.e("RES_CHECK" , "EMIT_PING_TEENPATTI");
//                                              long start = System.currentTimeMillis();
//                                              mSocket.emit("ping", start);
//                                              pingValue = pingValue+1;
//
//                                              if (pingValue == 3){
//                                                  Log.e("RES_CHECK" , "pingValue"+pingValue);
//
//                                                  //GameStatus();
//
//                                              }
