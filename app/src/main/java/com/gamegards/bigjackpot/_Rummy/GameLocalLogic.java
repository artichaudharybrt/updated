...
import static com.gamegards.bigjackpot._RummyPull.RummyPullGame.removeLastChars;
        ...
        if(isset)
        {
            ...
            for(int i= 0;i<CardNumberArray1.length;i++)
            {
                if(CardNumberArray1[i] >= 0)
                {
                    ...
                    Log.e("Array_Sort",""+numlist.get(i));
                }
...
//        String $actual_joker_card = RummyPointSocket.joker_card;
//        Log.e("RES_Actual_Joker",$actual_joker_card);
//
//        if(!current_card.equals($actual_joker_card)){
//            if($card_num.equalsIgnoreCase($joker_num))
//            {
//                $card_num = "0";
//            }
//            Log.e("RES_Joker",current_card+ " Matched");
//        }else {
//            Log.e("RES_Joker",current_card+ " Not Matched");
//        }
