...
import static com.gamegards.bigjackpot.Utils.Variables.RUMMYGAMEPOOL;
...
import com.gamegards.bigjackpot._Rummy.DeclareRules;
import com.gamegards.bigjackpot._Rummy.GameLocalLogic;
import com.gamegards.bigjackpot._Rummy.menu.DialogRulesRummy;
import com.gamegards.bigjackpot._RummyPull.Adapter.ShareWalletAdapter;
import com.gamegards.bigjackpot._RummyPull.Fragments.Bottom_listDialog;
import com.gamegards.bigjackpot._RummyPull.Fragments.GameUsersPoint_bt;
...
public class RummyPullGameSocket extends BaseActivity implements Animation.AnimationListener {
    int countvaue = 0;
    ...
    TextView txtPlay1wallet,txtPlay2wallet,txtPlay3wallet,txtPlay4wallet,txtPlay5wallet,txtPlay6wallet,txtPlay7wallet,txtwaitingforusers;
    ...
    TextView txtPlay2,txtPlay3,txtPlay4,txtPlay5,txtPlay6,txtPlay7,txt_timer, tv_pointStatus;
...
//        ActivityMainBinding binding;
    ...
    String pool_game="";
    private static final  String URL = Const.SOCKET_IP+"rummy_pool";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.v("RES_CLASS","RummyPullGameSocket");
            ...
            public void call(Object... args) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Log.e("RES_CHECK","On-connect_error");
            ...
            public void call(Object... args) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        //Toast.makeText(RummyPullGameSocket.this, "Trigger", Toast.LENGTH_SHORT).show();
                        String resp = String.valueOf(args[0]);
                        Log.e("RES_CHECK","On-trigger");
...
//                });
        ...
        img_cardhistory.setOnClickListener(v -> {

            Animation animation = AnimationUtils.loadAnimation(RummyPullGameSocket.this, R.anim.slide_from_top_screen);
        ...
        img_gamehistory.setOnClickListener(v -> {

            Animation animation = AnimationUtils.loadAnimation(RummyPullGameSocket.this, R.anim.slide_from_right_screen);
    ...
    private void getMyGameHistory() {
        ...
        ApiRequest.Call_Api(this, Const.rummy_pool_user_game_history, params, new Callback() {
            @Override
            public void Responce(String resp, String type, Bundle bundle) {
    ...
    private void Initialization() {
      ...
      //  registerReceiver(updatechatBroadcast, new IntentFilter("CHAT_UPDATE"));
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
            // For Android 12 (API 31) and above, specify whether the receiver is exported or not
            registerReceiver(updatechatBroadcast, new IntentFilter("CHAT_UPDATE"), Context.RECEIVER_NOT_EXPORTED);
        } else {
            // For lower versions (below Android 12), the default behavior is fine
            registerReceiver(updatechatBroadcast, new IntentFilter("CHAT_UPDATE"));
        }
...
//            findViewById(R.id.rltplayer7).setVisibility(View.VISIBLE);
        ...
        txtwaitingforusers =  findViewById(R.id.txtwaitingforusers);
            ...
            if(isPlayer2)
            {
                for (int k = 0; k < table_users.length(); k++) {
                    if (k == 0) {
                        ...
                        getTextView(R.id.tvTableType).setText("Pool Rummy " +numberamount);
...
//            bt_finish.setVisibility(visible ? View.VISIBLE : View.GONE);
    ...
    private void Parse_responseStatus(JSONObject jsonObject) throws JSONException {
        ...
        Log.e("RES_VALUE" , "Status Response "+jsonObject);
        ...
        if(game_users != null)
        {
            if (game_users.length() > 1){
                txtwaitingforusers.setVisibility(View.GONE);

            }else {
                txtwaitingforusers.setVisibility(View.VISIBLE);
        ...
        if(code.equalsIgnoreCase("200"))
        {
            ...
            Log.e("RES_VALUE", "game_users_cards: " + game_users_cards);
...
//                    }
                    ...
                    model.user_name = json_user.optString("name");
                    model.score = json_user.optInt("score",0);
                    model.total = json_user.optInt("total",0);
                    model.won = json_user.optInt("win",0);
...
//                            return;
                ...
                DialogDeclareCardsPool dialogDeclareCards = new DialogDeclareCardsPool(context){
                    @Override
...
//                SplitCardtoGroup();
                    ...
                    cardDistrubutionCount = new CountDownTimer(cardModelArrayList.size() * Variables.cardDistributionInterverl,
                        ...
                        @Override
                        public void onTick(long millisUntilFinished) {
                            Log.e("RES_CHECK" , ""+millisUntilFinished);
...
//                    countvaue++;
    ...
    private void CreateGroupFromSelect(boolean isDrag){
        ...
        if(count < 2 && !isDrag)
        {
            Toast.makeText(this, ""+getString(R.string.minimum_grouping2), Toast.LENGTH_SHORT).show();
            return;
        }
