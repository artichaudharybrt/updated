...
import static com.gamegards.bigjackpot.Utils.Variables.RUMMYGAMEDEAL;
...
import com.gamegards.bigjackpot._RummyDeal.Fragments.DealGameUsersPoint_bt;
...
public class RummyDealGameSocket extends BaseActivity implements Animation.AnimationListener {
    int countvaue = 0;
...
//        ActivityMainBinding binding;
    ...
    Socket mSocket;
    private static final  String URL = Const.SOCKET_IP+"rummy_deal";
            ...
            public void call(Object... args) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        //Toast.makeText(RummyDealGameSocket.this, "Trigger", Toast.LENGTH_SHORT).show();
...
//                    Functions.showToast(context, ""+message);
        ...
        img_cardhistory.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Animation animation = AnimationUtils.loadAnimation(RummyDealGameSocket.this, R.anim.slide_from_top_screen);
        ...
        img_gamehistory.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Animation animation = AnimationUtils.loadAnimation(RummyDealGameSocket.this, R.anim.slide_from_right_screen);
    ...
    private void getMyGameHistory() {
        ...
        ApiRequest.Call_Api(this, Const.rummy_deal_user_game_history, params, new Callback() {
            @Override
            public void Responce(String resp, String type, Bundle bundle) {
...
//                            return;
    ...
    private void getGame(final String url) {
        ...
        Log.e("RES_VALUE","EMIT-get-table "+jsonObjectJoinTable);
...
//    }
    ...
    int count = 8;
    TextView txtGameFinish,txtwaitingforusers;
    Timer timerstatus;
    int timertime = 6000;
...
//    }
    ...
    private void Parse_responseStatus(JSONObject jsonObject) throws JSONException {
        ...
        if(code.equalsIgnoreCase("200"))
        {
            ...
            Log.e("RES_VALUE" ,jsonObject.toString());
